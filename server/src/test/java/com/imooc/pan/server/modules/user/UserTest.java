...
import com.imooc.pan.server.RPanSeverLauncher;
...
@SpringBootTest(classes = RPanSeverLauncher.class)
@Transactional
public class UserTest {
    ...
    public void loginSuccess() {
        ...
        System.out.println("准备登录  1");

        UserLoginContext userLoginContext = createUserLoginContext();

        System.out.println(userLoginContext.getUsername());
